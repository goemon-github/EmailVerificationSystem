...
try {
    ...
    $mail->Username   = 'keiichiro.sugiyama91@gmail.com';   // SMTPユーザー名
    $mail->Password   = 'kferqktqhvytyher';                   // SMTPパスワード
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;   // 必要に応じてTLS暗号化を有効にします。
    $mail->Port       = 587;                              // 接続先のTCPポート

    // 受信者
    $mail->setFrom('keiichiro.sugiyama91@gmail.com', 'SpaceApp'); // 送信者設定
    $mail->addAddress('booya.8108@gmail.com', 'My User');          // 受信者を追加します。
